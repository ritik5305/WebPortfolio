          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link 
                  className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                    active === "AddSoftwareApplications"
                    ? "text-accent-foreground bg-accent"
                    : "text-muted-foreground"
                  
                  }  transition-colors hover:text-foreground md:h-8 md:w-8`}
                  onClick={() => setActive("AddSoftwareApplications")}
                >
                  <LayoutGrid className="h-5 w-5" />
                  <span className="sr-only">AddSoftwareApplications</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">Add Applicatins</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
...
// 6:53:31 tak chal raha hai tuta futa 