...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    linkedInURL,
    avatar: {
      public_id: cloudinaryResponseForAvatar.public_id, // Use correct variable
      url: cloudinaryResponseForAvatar.secure_url, // Use correct variable
    },
    resume: {
      public_id: cloudinaryResponseForResume.public_id, // Use correct variable
      url: cloudinaryResponseForResume.secure_url, // Use correct variable
    },
  });
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "66cb5394fb4ba95c02675270";
